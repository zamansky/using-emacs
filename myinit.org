...
#+BEGIN_SRC emacs-lisp
  ...
  (defun bjm/elfeed-show-all ()
    ...
    (defun bjm/elfeed-show-education ()
      (interactive)
      (bookmark-maybe-load-default-file)
      (bookmark-jump "elfeed-education"))
    (defun bjm/elfeed-show-daily ()
      (interactive)
      (bookmark-maybe-load-default-file)
      (bookmark-jump "elfeed-daily"))
    (defun bjm/elfeed-show-unread ()
      (interactive)
      (bookmark-maybe-load-default-file)
  ...
  (defmacro z/make-hydra ()
    `(defhydra hydra-elfeed ()
       "filter"
       ,@(z/make-elfeed-cats (elfeed-db-get-all-tags))
       )
  ...
  (z/make-hydra)
    ...
    :bind (:map elfeed-search-mode-map
		  ...
		  ("E" . bjm/elfeed-show-education)
		  ("T" . bjm/elfeed-show-daily)
		  ("U" . bjm/elfeed-show-unread)
		  ("q" . bjm/elfeed-save-db-and-bury)
		  ("*" . bjm/elfeed-show-starred)
                  ("j" . hydra-elfeed/body)
...
#+RESULTS:
| lambda | nil | (interactive) | (find-file ~/Dropbox/orgfiles/i.org) |
